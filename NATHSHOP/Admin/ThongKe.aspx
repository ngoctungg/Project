<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ThongKe.aspx.cs" Inherits="NATHSHOP.Admin.ThongKe" %>
        ...
        <ContentTemplate>
            ...
            <div style="padding: 20px">
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="gvTop" runat="server" Height="194px" Width="883px"
            ...
            <div style="padding: 20px">
                <table>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:GridView ID="gvKH" runat="server" Height="180px" Width="875px"
                                AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333"
                                GridLines="None">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
